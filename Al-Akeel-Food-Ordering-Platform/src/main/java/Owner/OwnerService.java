...
//    public List<MealEntity> listMeals(@PathParam("ownerId") long ownerId){
//        UserEntity owner = em.find(UserEntity.class, ownerId);
//        long restaurantId = owner.getRestaurantEntity().getId();
//        RestaurantService restaurantService = new RestaurantService();
...
//    }
    ...
    public String updateMealPrice(@PathParam("ownerId") long ownerId, @PathParam("mealId") long mealId, @PathParam("newPrice") double newPrice){
        UserEntity owner = em.find(UserEntity.class, ownerId);
        int restaurantId = (int) owner.getRestaurantEntity().getId();
        RestaurantService restaurantService = new RestaurantService();
    ...
    public List<Orders.OrderEntity> getCompletedOrders(@PathParam("ownerId") long ownerId){
        UserEntity owner = em.find(UserEntity.class, ownerId);
        int restaurantId = (int) owner.getRestaurantEntity().getId();
        RestaurantService restaurantService = new RestaurantService();
    ...
    public List<Orders.OrderEntity> getCancelledOrders(@PathParam("ownerId") long ownerId){
        UserEntity owner = em.find(UserEntity.class, ownerId);
        int restaurantId = (int) owner.getRestaurantEntity().getId();
        RestaurantService restaurantService = new RestaurantService();
    ...
    public String createReport(@PathParam("ownerId") long ownerId){
        UserEntity owner = em.find(UserEntity.class, ownerId);
        int restaurantId = (int) owner.getRestaurantEntity().getId();
        RestaurantService restaurantService = new RestaurantService();
